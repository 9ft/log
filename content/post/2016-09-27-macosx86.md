...
lastmod: 2019-12-09T14:51:00+0800
---
...
![](/img/post/2016-09-27-macosx86/2019-04-05.21.36.20.png)
...
![MultiBeast](/img/post/2016-09-27-macosx86/2016-09-02.1.30.31.png "MultiBeast")
...
- [ ] 修复花屏，睡眠唤醒后可临时解决。之前 `HorizontalSyncPulseWidth` 改为 `0x32` 已经不生效了。
...
官方的pkg安装包很久没更新了，使用[他人封装好的pkg安装包](https://github.com/chris1111/VoodooHDA-2.9.2-Clover-V14)直接安装

*目前存在问题，开机默认耳机插口，需要手动切换到扬声器*
...
![BCM94360HMB屏蔽针脚](/img/post/2016-09-27-macosx86/2019-11-01-BCM94360HMB.jpg "BCM94360HMB屏蔽针脚")
